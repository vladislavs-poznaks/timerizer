            ...
            <header className="w-full shadow-lg bg-white dark:bg-gray-700 items-center h-16 rounded-2xl z-40">
                <div className="relative z-20 flex flex-col justify-center h-full px-3 mx-auto flex-center">
                    <div className="relative items-center pl-1 flex w-full lg:max-w-68 sm:pr-2 sm:ml-0">
                        ...
                        <div className="relative p-1 flex items-center justify-end w-1/4 mx-5 sm:mx-0 sm:right-auto">
                            <a href="#" className="block relative border border-4 border-purple-600 rounded rounded-full">
                                <img
                                    alt="profile"
                                    src="https://avatars.dicebear.com/api/male/xxl.svg"
                                    className="mx-auto object-cover rounded-full h-10 w-10 p-1 "
                                />
                            </a>
                        </div>
                    </div>
